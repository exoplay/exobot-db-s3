Contributing to exobot-db-s3
======================

So you want to contribute to exobot-db-s3? Fantastic! Here's a brief overview on
how best to do so.
...
[create an issue](https://github.com/exoplay/exobot-db-s3/issues) before putting
...
1. [Fork the repository](https://github.com/exoplay/exobot-db-s3/fork_select) to
  your Github account.
...
exobot-db-s3 is MIT licensed. See details in the LICENSE file. This is a very permissive
